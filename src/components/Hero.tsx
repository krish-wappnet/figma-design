...
const Hero: React.FC = () => {
  return (
    <section className="relative w-full h-screen bg-black text-white px-6 sm:px-8 md:px-10 lg:px-12 py-8 overflow-hidden">
      ...
      <div className="relative w-full h-full flex items-center justify-center pt-20 px-4 sm:px-6 md:px-10 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center w-full max-w-6xl">
          
          {/* Left Column */}
          <div className="w-full lg:w-1/2 lg:pr-12 flex flex-col justify-center items-start text-center lg:text-left mb-12 lg:mb-0">
            {/* Subheading + Spoon */}
            ...
            {/* Heading */}
            <h1
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-yellow-200 mb-6"
          ...
          <div className="w-full lg:w-1/2 relative flex justify-center lg:justify-end">
            <div className="p-2 sm:p-4 bg-transparent relative">
              <img
                src={heroImage}
                alt="Fine Dining"
                className="w-[85%] max-w-[470px] h-auto object-cover"
              />
            </div>
          </div>
        </div>
      ...
      {/* Pagination */}
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex items-center space-x-2 text-sm">
